...
// All icons needed for PulperiaDashboard
import { Store as StoreIcon, Package, Plus, Edit, Trash2, Bell, Briefcase, Palette, Type, Megaphone, Image, MessageSquare, Shield, Clock, MapPin, Phone, Check, Share2, Copy, Globe, Wifi } from 'lucide-react';
          ...
          <form onSubmit={handleCreatePulperia} className="space-y-5 mt-2">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  <Input
                    value={pulperiaForm.twitter_url}
                    onChange={(e) => setPulperiaForm({ ...pulperiaForm, twitter_url: e.target.value })}
